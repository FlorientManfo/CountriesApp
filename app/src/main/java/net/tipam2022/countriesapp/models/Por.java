...
public class Por implements Parcelable
{

    private String official;
    private String common;
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();
    public final static Creator<Por> CREATOR = new Creator<Por>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Por createFromParcel(android.os.Parcel in) {
            return new Por(in);
        }

        public Por[] newArray(int size) {
            return (new Por[size]);
        }
    ...
    protected Por(android.os.Parcel in) {
