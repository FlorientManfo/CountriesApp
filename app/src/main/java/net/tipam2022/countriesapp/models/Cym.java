...
public class Cym implements Parcelable
{
    ...
    public final static Creator<Cym> CREATOR = new Creator<Cym>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Cym createFromParcel(android.os.Parcel in) {
            return new Cym(in);
        }

        public Cym[] newArray(int size) {
            return (new Cym[size]);
        }
    ...
    protected Cym(android.os.Parcel in) {
     ...
     * @param official
     */
    public Cym(String official, String common) {
        super();
