...
public class Fra implements Parcelable
{
    ...
    public final static Creator<Fra> CREATOR = new Creator<Fra>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Fra createFromParcel(android.os.Parcel in) {
            return new Fra(in);
        }

        public Fra[] newArray(int size) {
            return (new Fra[size]);
        }
    ...
    protected Fra(android.os.Parcel in) {
     ...
     * @param official
     */
    public Fra(String official, String common) {
        super();
